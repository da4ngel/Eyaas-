...
import { courses as items } from "@/content/site";
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {items.map((it, i) => (
            ...
            >
              <TiltCard glare className="h-full rounded-xl">
                <Card className="h-full transition-shadow hover:shadow-[var(--shadow-glow)]">
                <CardHeader>
